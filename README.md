...
**[EN]** Landing page design featuring a captivating video background. Created using HTML, CSS, and JavaScript only.

**[FR]** Page d'accueil avec un background vidéo captivant sur le thème de l'Aventure. Réalisée uniquement en HTML, CSS et JavaScript.
